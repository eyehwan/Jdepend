...
public class JDependRecorder extends Recorder //BuildSteps that run after the build is completed.
//Recorder is a kind of Publisher that collects statistics from the build, and can mark builds as unstable/failure. 
//This marking ensures that builds are marked accordingly before notifications are sent via Notifiers. 
