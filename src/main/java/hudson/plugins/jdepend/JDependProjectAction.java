...
import hudson.model.AbstractProject;//Base implementation of Jobs that build software. For now this is primarily the common part of Project and MavenModule
